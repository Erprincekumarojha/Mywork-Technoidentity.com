...
public class CaretakerNotificationControllerTest {
	...
	@Test
	@Order(1)
	public void getCaretakerNotifications1() throws Exception {
	...
	@Test
	@Order(2)
	public void getCaretakerNotifications2() throws Exception {

		MvcResult result = mvc.perform(post("/patient")
				.header("Content-Type", "application/json")
				.content("{\"patientId\":\"VITDAN004456\"}"))
				.andReturn();
